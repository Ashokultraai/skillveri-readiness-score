...
def estimate_sessions_to_readiness(model, features_df, sessions_df, feature_cols):
    ...
    """
    from src.feature_engineering import engineer_features, compute_readiness_at_session_k
...
def save_artifacts(results, best_model, shap_importance, feature_cols, 
    ...
    artifacts_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'models')
